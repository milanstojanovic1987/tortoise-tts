...
MODELS = {
    'autoregressive.pth': 'https://huggingface.co/milans213/tortoiseTTS_sr_en/blob/main/1200_sr_en.pth',
...
class TextToSpeech:
    ...
    def __init__(self, autoregressive_batch_size=None, models_dir=MODELS_DIR, 
        ...
        if os.path.exists(f'{models_dir}/autoregressive.ptt'):
            ...
            self.autoregressive.load_state_dict(torch.load(get_model_path('1200_sr_en.pth', models_dir)), strict=False)
